<x-app-layout title="imunisasi-bumil">
    @push('css')
    ...
    <div class="row">
        ...
        <div class="col-md-8 d-flex justify-content-end">
            <a href="{{ route('imunisasibumil.create') }}" target="blank" class="btn btn-primary">Cetak</a>
        </div>
        <div class="col-12 mt-1">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">
                        <div class="row">
                            <h4>Imunisasi Bumil : {{ Request('posyandu') }}</h4>
                        </div>
                    </h4>
                            ...
                            <tbody>
                                @foreach ($imunisasiBumil as $imunisasi)
                                    <tr>
                                        ...
                                        <td>{{ $imunisasi->updated_at->Format('d/m/Y') }}</td>
                                        <td>
